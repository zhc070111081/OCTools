...
@class HMWebView;
@protocol UIHMWebViewDelegate <NSObject>
...
- (void)webView:(HMWebView *)webView didReceiveScriptMessageWithName:(nullable NSString *)name body:(nullable id)body;

/// 接收特定URL处理回调
/// @param webView webView description
/// @param name name description
/// @param request request description
- (void)webView:(HMWebView *)webView decidePolicyForNavigationAction:(nullable WKNavigationAction *)name request:(nullable NSString *)request;

/// web load finish
/// @param webView webView description
/// @param isLoadSuccess is load success YES or NO
- (void)webView:(HMWebView *)webView didFinishNavigation:(BOOL) isLoadSuccess;

@end


@interface HMWebView : UIView

/// 代理方法
@property (nullable, weak, nonatomic) id<UIHMWebViewDelegate> delegate;
