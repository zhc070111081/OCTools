...
#import "HMDrawBoardView.h"
#import "HMDrawBezierPath.h"

@interface HMDrawBoardView ()

@property (nullable, nonatomic, strong) HMDrawBezierPath *path;

@property (nullable, nonatomic, strong) NSMutableArray *paths;

@end

@implementation HMDrawBoardView
...
- (void)pan:(UIPanGestureRecognizer *)pan
{
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        self.path = [[HMDrawBezierPath alloc] init];
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        if ([object isKindOfClass:[UIImage class]]) {
            ...
            HMDrawBezierPath *path = (HMDrawBezierPath *)object;
            [path.pathColor set];
            [path stroke];
        }
    }
